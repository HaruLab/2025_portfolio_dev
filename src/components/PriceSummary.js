...
const PriceSummary = ({
  ...
  return (
    <div className="mt-10 p-6 bg-[var(--select-menu-background)] rounded-lg transition-colors duration-300">
      <h2 className="text-xl font-bold mb-5 text-left text-gray-800 dark:text-gray-200">
        料金
      </h2>
      <div className="border-t border-gray-300 dark:border-gray-700 pt-5 text-sm">
